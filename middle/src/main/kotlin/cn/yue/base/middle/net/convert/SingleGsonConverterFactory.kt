 ...
 */
class SingleGsonConverterFactory private constructor(private val gson: Gson?) : Converter.Factory() {
    ...
    companion object {
         ...
         */
        @JvmOverloads
        fun create(gson: Gson = Gson()): SingleGsonConverterFactory {
            return SingleGsonConverterFactory(gson)
        }
    }
}