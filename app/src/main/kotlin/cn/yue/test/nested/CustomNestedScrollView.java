...
public class CustomNestedScrollView extends FrameLayout implements NestedScrollingParent3,
    ...
    public void dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed,
        ...
        printLog("dispatchNestedScroll: ",dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed,
                offsetInWindow, type, consumed);
    }

    private void printLog(String before, Object... other) {
        StringBuilder builder = new StringBuilder();
        for (int i = 0; i < other.length; i++) {
            builder.append(other[i] + ", ");
        }
        Log.d(TAG, " " + before + builder.toString());
    }
    ...
    public boolean startNestedScroll(int axes, int type) {
        printLog("startNestedScroll: ", axes, type);
    ...
    public void stopNestedScroll(int type) {
        ...
        printLog("stopNestedScroll: ", type);
    }

    @Override
    public boolean hasNestedScrollingParent(int type) {
        printLog("hasNestedScrollingParent: " + type);
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow,
                                           int type) {
        printLog("dispatchNestedPreScroll: ", dx, dy, consumed, offsetInWindow, type);
        int scrollOffset = computeVerticalScrollRange() - computeVerticalScrollOffset();
        Log.d(TAG, "dispatchNestedPreScroll: " + scrollOffset + ";" + getMeasuredHeight());
        if (dy > 0) {
            //向上 到底了，不消耗
            if (scrollOffset > getMeasuredHeight()) {
                scrollBy(0, dy);
                consumed[1] = dy;
            }
        } else {
        ...
        return mChildHelper.dispatchNestedPreScroll(dx, 0, consumed, offsetInWindow, type);
    }

    private boolean isChildToTop() {
        return false;
    }
    ...
    public boolean dispatchNestedFling(float velocityX, float velocityY, boolean consumed) {
        printLog("dispatchNestedFling: ",  velocityX, velocityY, consumed);
        return mChildHelper.dispatchNestedFling(velocityX, velocityY, consumed);
    }

    @Override
    public boolean dispatchNestedPreFling(float velocityX, float velocityY) {
        printLog("dispatchNestedPreFling: ", velocityX, velocityY);
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed,
        ...
        printLog("onNestedScroll: ", dyConsumed, dyUnconsumed, type);
    ...
    public boolean onStartNestedScroll(@NonNull View child, @NonNull View target, int axes,
                                       int type) {
        printLog("onStartNestedScroll: ", child, target, axes, type);
    ...
    public void onNestedScrollAccepted(@NonNull View child, @NonNull View target, int axes,
                                       int type) {
        printLog("onNestedScrollAccepted: ", child, target, axes, type);
    ...
    public void onStopNestedScroll(@NonNull View target, int type) {
        printLog("onStopNestedScroll: ", target, type);
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed,
        ...
        printLog("onNestedScroll: ", target, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed, type);
    ...
    public void onNestedPreScroll(@NonNull View target, int dx, int dy, @NonNull int[] consumed,
                                  int type) {
        printLog("onNestedPreScroll: ", target, dx, dy, type);
    ...
    public boolean onStartNestedScroll(
        ...
        printLog("onStartNestedScroll: ", child, target, axes);
    ...
    public void onNestedScrollAccepted(
            @NonNull View child, @NonNull View target, int axes) {
        printLog("onNestedScrollAccepted: ", child, target, axes);
        onNestedScrollAccepted(child, target, axes, ViewCompat.TYPE_TOUCH);
    }

    @Override
    public void onStopNestedScroll(@NonNull View target) {
        printLog("onStopNestedScroll: ", target);
    ...
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed,
        ...
        printLog("onNestedScroll: ", target, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed);
        onNestedScrollInternal(dyUnconsumed, ViewCompat.TYPE_TOUCH, null);
    }

    @Override
    public void onNestedPreScroll(@NonNull View target, int dx, int dy, @NonNull int[] consumed) {
        printLog("onNestedPreScroll: ", target, dx, dy);
    ...
    public boolean onNestedFling(
        ...
        printLog("onNestedFling: ", velocityX, velocityY, consumed);
        if (!consumed) {
    ...
    public boolean onNestedPreFling(@NonNull View target, float velocityX, float velocityY) {
        printLog("onNestedPreFling: ", velocityX, velocityY);
