...
class ThreadPoolUtils {
     ...
     */
    constructor(type: Type, corePoolSize: Int) {
        // 构造有定时功能的线程池
        ...
        when (type) {
            ThreadPoolUtils.Type.FixedThread ->
                // 构造一个固定线程数目的线程池
            ...
            ThreadPoolUtils.Type.SingleThread ->
            ...
            ThreadPoolUtils.Type.CachedThread ->
                // 构造一个缓冲功能的线程池
                // ThreadPoolExecutor(0, Integer.MAX_VALUE, 60L, TimeUnit.SECONDS, new SynchronousQueue<Runnable>());
                exec = Executors.newCachedThreadPool()
            else -> exec = scheduleExec
        }
    }
