...
object NotificationUtils {
     ...
     */
    fun notify(id: Int, consumer: (builder: NotificationCompat.Builder?) -> Unit) {
     ...
     * @param consumer The consumer of create the builder of notification.
     */
    fun notify(tag: String?, id: Int, consumer: (builder: NotificationCompat.Builder?) -> Unit) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    fun notify(id: Int, channelConfig: ChannelConfig, consumer: (builder: NotificationCompat.Builder?) -> Unit) {
     ...
     * @param consumer      The consumer of create the builder of notification.
     */
    fun notify(tag: String?, id: Int, channelConfig: ChannelConfig, consumer: (builder: NotificationCompat.Builder?) -> Unit) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val nm = Utils.getContext().getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
    ...
    @JvmStatic
    fun initChannelConfig(channelConfig: ChannelConfig) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val nm = Utils.getContext().getSystemService(Context.NOTIFICATION_SERVICE) as NotificationManager
            nm.createNotificationChannel(channelConfig.notificationChannel!!)
        }
