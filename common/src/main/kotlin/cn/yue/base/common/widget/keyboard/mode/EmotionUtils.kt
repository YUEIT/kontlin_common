...
class EmotionUtils {
    ...
    companion object {
        ...
        val allEmotionPage: List<IEmotionPage>
            get() {
        ...
        private var emotionClickListener: OnEmotionClickListener? = null

        var onEmotionClickListener: OnEmotionClickListener?
            get() = emotionClickListener
            set(clickListener) {
                if (clickListener != null) {
                    emotionClickListener = clickListener
                }
            }
